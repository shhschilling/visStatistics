...
# ============================================================================
# EXAMPLE 1: Two groups, one normal group and one normal group with an
# outlier. Equal variances -> Welch t.test(), as n > 30 in both groups.
# ============================================================================
...
# ============================================================================
# EXAMPLE 2: Two groups, one normal group, unequal variances -> Wilcoxon
# rank-sum exact test.
# ============================================================================
...
2. If n ≤ 50: Check normality with Shapiro test
...
cat("Data summary:\n")
extreme_summary <- aggregate(
  response ~ group, extreme_data,
