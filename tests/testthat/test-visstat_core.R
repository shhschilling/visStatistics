# Test file should be placed in tests/testthat/ directory
# File name: test-visstat_core.R
...
test_that("visstat_core - Two-level factor: t-test vs Wilcoxon decision path", {
  ...
  # Skip if visstat_core not available
  skip_if_not(exists("visstat_core"), "visstat_core function not available")
  ...
  result_large <- suppress_graphics({
    visstat_core(large_data, "values", "group")
  })
  ...
  result_normal <- suppress_graphics({
    visstat_core(normal_data, "values", "group")
  })
  ...
  result_wilcox <- suppress_graphics({
    visstat_core(skewed_data, "values", "group")
  })
  ...
  result_na <- suppress_graphics({
    visstat_core(na_data, "values", "group")
  })
  ...
  result_unequal <- suppress_graphics({
    visstat_core(unequal_var_data, "values", "group")
  })
...
test_that("visstat_core - Multi-level factor: ANOVA decision path", {
  ...
  result_anova <- suppress_graphics({
    visstat_core(anova_normal_homo, "values", "group")
  })
  expect_s3_class(result_anova, "visstat")
  expect_true(length(result_anova) > 0)
  expect_true(is.list(result_anova))
  ...
  result_welch <- suppress_graphics({
    visstat_core(anova_normal_hetero, "values", "group")
  })
  ...
  result_kruskal <- suppress_graphics({
    visstat_core(anova_nonnormal, "values", "group")
  })
  ...
  result_four <- suppress_graphics({
    visstat_core(four_group_data, "values", "group")
  })
  ...
  result_unbalanced <- suppress_graphics({
    visstat_core(unbalanced_data, "values", "group")
  })
...
test_that("visstat_core - Numeric vs Numeric: Linear regression path", {
  ...
  result_lm <- suppress_graphics({
    visstat_core(linear_normal, "y", "x")
  })
  ...
  result_lm_nonnormal <- suppress_graphics({
    visstat_core(linear_nonnormal, "y", "x")
  })
  ...
  suppressWarnings({
    result_perfect <- suppress_graphics({
      visstat_core(perfect_data, "y", "x")
    })
  })
  ...
  result_no_corr <- suppress_graphics({
    visstat_core(no_corr_data, "y", "x")
  })
  ...
  result_outlier <- suppress_graphics({
    visstat_core(outlier_data, "y", "x")
  })
...
test_that("visstat_core - Categorical vs Categorical: Independence tests", {
  ...
  result_chisq <- suppress_graphics({
    visstat_core(large_contingency, "cat1", "cat2")
  })
  expect_s3_class(result_chisq, "visstat")
  has_statistical_content <- length(result_chisq) > 0 && !all(sapply(result_chisq, is.null))
  expect_true(has_statistical_content)
  ...
  result_fisher <- suppress_graphics({
    visstat_core(small_contingency, "cat1", "cat2")
  })
  expect_s3_class(result_fisher, "visstat")
  has_statistical_content <- length(result_fisher) > 0 && !all(sapply(result_fisher, is.null))
  expect_true(has_statistical_content)
  ...
  result_2x2 <- suppress_graphics({
    visstat_core(two_by_two, "cat1", "cat2")
  })
  expect_s3_class(result_2x2, "visstat")
  has_statistical_content <- length(result_2x2) > 0 && !all(sapply(result_2x2, is.null))
  expect_true(has_statistical_content)
  ...
  result_multi <- suppress_graphics({
    visstat_core(multi_level, "cat1", "cat2")
  })
  expect_s3_class(result_multi, "visstat")
  has_statistical_content <- length(result_multi) > 0 && !all(sapply(result_multi, is.null))
  expect_true(has_statistical_content)
  ...
  result_perfect_assoc <- suppress_graphics({
    visstat_core(perfect_assoc, "cat1", "cat2")
  })
  ...
  result_independent <- suppress_graphics({
    visstat_core(independent_data, "cat1", "cat2")
  })
...
test_that("visstat_core - Edge cases and error handling", {
  ...
  result_or_error <- tryCatch({
    suppressWarnings(suppress_graphics({
      visstat_core(single_level, "values", "group")
    }))
...
test_that("visstat_core - Return value structure and attributes", {
  ...
  result <- suppress_graphics({
    visstat_core(test_data, "values", "group")
  })
  ...
  result_90 <- suppress_graphics({
    visstat_core(test_data, "values", "group", conf.level = 0.90)
  })
  expect_s3_class(result_90, "visstat")
  
  result_99 <- suppress_graphics({
    visstat_core(test_data, "values", "group", conf.level = 0.99)
  })
  expect_s3_class(result_99, "visstat")
  
  # Case 6.6: Plot generation flags
  suppressWarnings({
    result_no_plots <- suppress_graphics({
      visstat_core(test_data, "values", "group", graphicsoutput = NULL)
    })
  })
...
test_that("visstat_core - Statistical correctness verification", {
  ...
  result_strong <- suppress_graphics({
    visstat_core(strong_diff_data, "values", "group")
  })
  ...
  result_no_diff <- suppress_graphics({
    visstat_core(no_diff_data, "values", "group")
  })
  ...
  result_linear <- suppress_graphics({
    visstat_core(linear_data, "y", "x")
  })
...
test_that("visstat_core - Decision path verification", {
  ...
  result_two_level <- suppress_graphics({
    visstat_core(two_level_data, "values", "group")
  })
  ...
  result_multi_level <- suppress_graphics({
    visstat_core(multi_level_data, "values", "group")
  })
  ...
  result_numeric <- suppress_graphics({
    visstat_core(numeric_data, "y", "x")
  })
  ...
  result_factors <- suppress_graphics({
    visstat_core(factor_data, "cat1", "cat2")
  })
