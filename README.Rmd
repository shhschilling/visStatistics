...
The wrapper function `visstat()` standardises the input and forwards it to the core function  `visstat_core()`, which
...
linreg_cars_99 <- visstat(cars$speed ,cars$dist, conf.level = 0.99)
```
