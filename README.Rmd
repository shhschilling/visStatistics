...
For an overview of the decision logic see
...
The `vignette("visStatistics")`allows you to get familiar with all features of
`visStatistics`. It documents in detail its  decision logic illustrated by below examples.
