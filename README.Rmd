...
```{r fig-decision-tree, echo=FALSE, fig.cap="<em>Decision tree used to select the appropriate statistical test for a categorical predictor and numeric response, based on the number of factor levels, normality and homoscedasticity.</em>", out.width="100%,fig.height =100% "}
...
## Numerical response ~ numerical feature: Linear Regression
