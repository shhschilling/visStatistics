...
Increasing the confidence level `conf.level` from the default 0.95 to 0.99 leads
to wider confidence and prediction bands:

```{r pressure, echo = FALSE}
vis_women_99 <- visstat( weight~height,data=women,conf.level = 0.99) #formula input
```
