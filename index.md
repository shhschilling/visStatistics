...
factors.](reference/figures/README-kendall-ordered-1.png)![Kendall's
tau-b rank correlation between two five-point Likert items. Shows a
jittered rank-rank scatter annotated with tau-b, the p-value, and sample
size, plus a mosaic plot whose tile ordering reflects the level ordering
of the ordered factors.](reference/figures/README-kendall-ordered-2.png)
