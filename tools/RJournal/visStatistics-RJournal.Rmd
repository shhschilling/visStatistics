...
#### Assumption tests{.unnumbered }

To select tests of central tendencies, the routing depends on  
p-values of assumption tests. But no single (assumption) test maintains optimal Type I
...
<!-- A solely  p-values driven decision logic  can therefore lead to both type I -->
...
rule-of-thumb threshold to bypass residual-normality testing. For smaller
samples, Shapiro--Wilk is used to route between mean-based and
...
#### Combining assumption tests {.unnumbered }
...
#### Limited number of tests {.unnumbered }
...
#### Only base R for plotting{.unnumbered }
...
#### Bootstrapping as alterntive{.unnumbered }
