...
Throughout the remainder, data of class `"numeric"` or `"integer"` are referred to bei their common `mode` `numeric`, while data of class `"factor"` are referred to as categorical.
