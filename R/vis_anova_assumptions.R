...
#' Visualisation of the normality distribution of the standardised residualsd
#'
...
#'
#' @return \code{list} containing the test statistics of the anova, the p values  generated by the
