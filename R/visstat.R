...
#'
#' @return Statistics and graphical represenation of test with highest statistical power meeting assumptions.
#' @examples
      ...
      (typefactor == "factor") && nlevels(fact) == 2)
  {
    ...
    if (length(twosamples) < 3) {
          ...
          length(twosamples$sample2) > 100)
      {
        ...
        saveGraphCairo(paste("ttest_", name_of_sample, "_", name_of_factor, sep = ""))
      }
