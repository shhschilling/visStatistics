...
<!-- where either nitrogen (N), phosphate (P) or potassium (K) was spread. -->


#### One way test

```{r}
 oneway_npk=visstat(sleep,"yield","block")
```
...
# Contingency tables: 
Unbuilt data sets of count data present the data  often as multidimensional arrays.

can be transformed to column wise structure with the helper function \code{counts_to_cases(as.data.frame())}
