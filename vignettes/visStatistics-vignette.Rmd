...
Inserting the corrected $\alpha_{Sidak}$ into the standard formula for confidence intervals we obtain the Sidak  corrected boundaries of the confidene interval
