...
`visStatistics` automatically selects and visualises appropriate statistical hypothesis tests between  two column vectors of type of class `"numeric"`,
`"integer"`, or `"factor"`.
...
to bei their common `mode` `numeric`, while data of class `"factor"` are referred to as categorical.
