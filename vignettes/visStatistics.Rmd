...
rule-of-thumb threshold to bypass residual-normality testing. This
threshold is a pragmatic rule and cannot guarantee adequate
normal-approximation behaviour for strongly skewed or heavy-tailed
distributions.

Simulation studies suggest that Shapiro--Wilk has the highest power
among normality tests in small to moderate ($n = 10$ to 100) sample
sizes [@Razali:2011]. Accordingly, Shapiro--Wilk is used to route
between mean-based and rank-based methods when all groups contain fewer
than 50 observations. For larger groups, however, Shapiro--Wilk, as all
normality tests, becomes overly sensitive and can reject residual
