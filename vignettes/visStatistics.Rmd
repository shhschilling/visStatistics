...
author: 
  - name: "Sabine Schilling"
    affiliation: "Institute of Tourism and Mobility, Lucerne Unviversity of Applied Sciences and Arts"
    email: "sabine.schilling@protonmail.com"
date: "`r Sys.Date()`"
output:
 #html_vignette: #for CRAN, much more lightweight 
 bookdown::html_document2:  #for correct display in pkdown of section numbering
# pdf_document:
    toc: true
...
(`ad.test()`). These tests offer complementary strengths: Shapiro–Wilk generally exhibits greater
