...
When the response is an ordered factor, `visstat()` converts it internally to numeric ranks and redirects to the non-parametric path (see examples in Section [Comparing central tendencies](#comparing-central-tendencies)).
