...
-   $Y_i$ are the model reandom variables

-   $x_{ij}$ are the predictor values

-   $\beta_0, \beta_1, \ldots, \beta_k$ are the $(k+1)$ parameters

-   $\varepsilon_i$ are the normally distributed error terms with constant, 
    unknwon variance $\sigma^2$
...
The residuals are our estimators for the unknwon error terms $\epsilon_i$. 
...
The function `vis_anova_assumptions()` provides unified diagnostic tools for all GLM variants.
