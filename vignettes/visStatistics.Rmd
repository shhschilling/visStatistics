...
```{r gamma-glm-plot, echo=FALSE, fig.cap="Gamma GLM with log link fitted to the \\texttt{airquality} dataset (\\texttt{Wind} vs.\\ \\texttt{Ozone}). The red curve shows the fitted Gamma GLM; the y-axis is on a log scale."}
