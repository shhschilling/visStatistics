...
The decision logic assumes normality if the Shapiro--Wilk test yields a p-value greater than $\alpha$, as, for a majority distributions, it is the most powerful test [@Razali:2011].
...
But assessment for normality should never solely rely on p-values, but should be complimented by visual inspections. Therefore  the function generates two diagnostic plots:
