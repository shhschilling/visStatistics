...
`print()` displays the test used, the p-value, and the effect size; `summary()` provides the full contents of the returned object, including assumption tests, post-hoc comparisons, and `effect_size`.
