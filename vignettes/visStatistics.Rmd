...
The choice of statistical tests performed by the core function visstat() depends on the type of the data (quantitative numerical or qualitative categorical), the number of levels whilst dealing with categorical data and the distribution of the data (normally distributed versus non-normally distributed).
...
`visStatistics` offers a fully automated workflow especially suited for server-based deployments of R. It has been successfully applied for unbiased analysis of medical raw data.
