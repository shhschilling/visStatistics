...
It controls the family-wise error rate using a critical value from the studentised range distribution, which properly accounts for the correlated nature of pairwise comparisons sharing a common residual variance [@HochbergTamhane:1987].
...
\alpha$ as calculated with the `bartlett.test()`), and the p-value of the `aov()` is displayed.
