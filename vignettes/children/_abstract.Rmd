...
The workflow serves quick data exploration; its automation makes it suited to server-side R applications, where users select solely variables through a web interface and receive the full analysis.
