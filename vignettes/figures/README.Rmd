...
`visStatistics` allows the visualization and statistical analysis of raw data. It automatically selects and applies the most appropriate hypothesis test to evaluate the relationship between a response (`varsample`) and a feature (`varfactor`) within a `data.frame`.
