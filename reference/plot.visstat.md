...
stored path is printed, for captured plots the plot is replayed on a
fresh graphics device via
...
plot(anova_path)
#> Plot [1] stored in /var/folders/5c/n85wqnh95l50qbp3s9l0rp_w0000gn/T//RtmpGBhfn4/glm_assumptions_yield_block.png
#> Plot [2] stored in /var/folders/5c/n85wqnh95l50qbp3s9l0rp_w0000gn/T//RtmpGBhfn4/anova_yield_block.png
